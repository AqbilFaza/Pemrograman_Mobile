...
import 'package:project6/app/data/api_sevice.dart';
import 'package:project6/app/model/article_results.dart';
...
void main() {
  ...
  setUp(() {
    ...
    apiService = ApiService(); // Pass the mock client to ApiService client: mockClient
  });

  group('ApiService', () {
    test('fetchArticles returns a list of articles if response is successful', () async {
